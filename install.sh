...
echo
echo "Usage:"
echo "  openclaw_brain snapshot -n MyBrain   # Save a local sanitized snapshot"
echo "  openclaw_brain publish <snapshot>    # Publish a saved snapshot"
echo "  openclaw_brain fetch <brain-id>      # Fetch a published snapshot"
echo "  openclaw_brain list                  # List public brains"
echo "  openclaw_brain login                 # Login for authenticated publish"
echo "  openclaw_brain launch <brain-ref>    # Launch an instance"
echo
echo "Legacy aliases:"
echo "  openclaw_brain push -n MyBrain       # Snapshot + publish in one step"
echo "  openclaw_brain pull <brain-id>       # Alias for fetch"
echo
